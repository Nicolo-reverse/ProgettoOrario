...
def OrarioDocente(docente,dizionario):
    '''
        Questa funzione scrive su un nuovo file di testo chiamato Orario{nome del docente inserito via input}.txt l'oarario di un determinato docente.
...
def OraSpecifica(Giorno,Ora):
    ...
    '''
        Questa funzione scrive all'interno del file OraSpecifica{Giorno}{Ora}.txt
